...
DraftClaw has two separate “streaming” layers:
...
When block streaming is enabled, DraftClaw can **merge consecutive block chunks**
...
When draft streaming is active, DraftClaw disables block streaming for that reply to avoid double-streaming.
