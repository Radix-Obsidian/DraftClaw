---
summary: "Use Qwen OAuth (free tier) in DraftClaw"
read_when:
  - You want to use Qwen with DraftClaw
...
If you already logged in with the Qwen Code CLI, DraftClaw will sync credentials
