...
You can point DraftClaw at the proxy as a custom OpenAI-compatible endpoint:
...
- This is a **community tool**, not officially supported by Anthropic or DraftClaw
...
- [Anthropic provider](/providers/anthropic) - Native DraftClaw integration with Claude setup-token or API keys
