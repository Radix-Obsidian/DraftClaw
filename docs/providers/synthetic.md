---
summary: "Use Synthetic's Anthropic-compatible API in DraftClaw"
read_when:
...
Synthetic exposes Anthropic-compatible endpoints. DraftClaw registers it as the
...
Note: DraftClaw's Anthropic client appends `/v1` to the base URL, so use
