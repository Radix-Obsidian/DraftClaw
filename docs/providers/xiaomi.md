---
summary: "Use Xiaomi MiMo (mimo-v2-flash) with DraftClaw"
read_when:
  - You want Xiaomi MiMo models in DraftClaw
...
the [Xiaomi MiMo console](https://platform.xiaomimimo.com/#/console/api-keys). DraftClaw uses
