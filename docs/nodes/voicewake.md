...
DraftClaw treats **wake words as a single global list** owned by the **Gateway**.
...
- `~/.draftclaw/settings/voicewake.json`

Shape:

```json
{ "triggers": ["draftclaw", "claude", "computer"], "updatedAtMs": 1730000000000 }
```
