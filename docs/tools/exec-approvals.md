...
- **gateway host** → `draftclaw` process on the gateway machine
...
`~/.draftclaw/exec-approvals.json` directly.

CLI: `draftclaw approvals` supports gateway or node editing (see [Approvals CLI](/cli/approvals)).
