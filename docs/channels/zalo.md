...
- Install via CLI: `draftclaw plugins install @draftclaw/zalo`
...
1. Install the Zalo plugin:
   - From a source checkout: `draftclaw plugins install ./extensions/zalo`
   - From npm (if published): `draftclaw plugins install @draftclaw/zalo`
...
- Approve via:
  - `draftclaw pairing list zalo`
  - `draftclaw pairing approve zalo <CODE>`
...
- Example: `draftclaw message send --channel zalo --target 123456789 --message "hi"`.

## Troubleshooting

**Bot doesn't respond:**

- Check that the token is valid: `draftclaw channels status --probe`
- Verify the sender is approved (pairing or allowFrom)
- Check gateway logs: `draftclaw logs --follow`
