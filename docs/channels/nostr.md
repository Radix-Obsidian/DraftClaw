...
read_when:
  - You want DraftClaw to receive DMs via Nostr
...
Nostr is a decentralized protocol for social networking. This channel enables DraftClaw to receive and respond to encrypted direct messages (DMs) via NIP-04.

## Install (on demand)

### Onboarding (recommended)

- The onboarding wizard (`draftclaw onboard`) and `draftclaw channels add` list optional channel plugins.
...
```bash
draftclaw plugins install @draftclaw/nostr
```

Use a local checkout (dev workflows):

```bash
draftclaw plugins install --link <path-to-draftclaw>/extensions/nostr
```
...
```json
{
  "channels": {
    "nostr": {
      ...
      "profile": {
        "name": "draftclaw",
        "displayName": "DraftClaw",
        "about": "Personal assistant DM bot",
        "picture": "https://example.com/avatar.png",
        "banner": "https://example.com/banner.png",
        "website": "https://example.com",
        "nip05": "draftclaw@example.com",
        "lud16": "draftclaw@example.com"
      }
    }
  }
}
