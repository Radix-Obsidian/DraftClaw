...
read_when:
  - You are building a DraftClaw plugin
  - You need to ship a plugin config schema or debug plugin validation errors
title: "Plugin Manifest"
---

# Plugin manifest (draftclaw.plugin.json)

Every plugin **must** ship a `draftclaw.plugin.json` file in the **plugin root**.
DraftClaw uses this manifest to validate configuration **without executing plugin
