...
<p align="center">
  <strong>THE DESK IS LIVE.</strong>
</p>

<p align="center">
  <a href="LICENSE"><img src="https://img.shields.io/badge/License-MIT-blue.svg?style=for-the-badge" alt="MIT License"></a>
  <img src="https://img.shields.io/badge/Status-BETA-00E092?style=for-the-badge" alt="Beta">
  <img src="https://img.shields.io/badge/21+-Only-FF4D4D?style=for-the-badge" alt="21+ Only">
</p>

---

**DraftClaw** is not a chatbot. It is a **Sports Operating System** that runs on your local machine (ASUS G14 optimized). It connects to *The-Odds-API*, calculates Expected Value (EV) against sharp books like Pinnacle, and generates viral-ready betting analysis.

> *"Sharp money moves first. Track it."*

---

## 🎯 The Feature: "The Anchor"

DraftClaw includes an autonomous personality called **The Anchor** that:

1. **Scans** the NBA/NFL slate for line discrepancies
2. **Identifies** "Blasphemous Inefficiencies" (EV > 10%)
3. **Generates** Stephen A. Smith-style rants explaining the pick
4. **Creates** deep links to FanDuel/DraftKings for instant execution
...
# Talk to The Anchor
draftclaw agent --message "What's the sharpest play on tonight's slate?" --thinking high
```
...
| Feature | Description |
|---------|-------------|
| **Moneyball Protocol** | Real-time EV calculation against sharp books |
| **Sharp Money Tracking** | Follow the smart money movement |
| **Line Shopping** | Cross-book comparison for best odds |
| **The Anchor** | AI personality for sports analysis |
| **Multi-Channel** | WhatsApp, Telegram, Discord alerts |
...
DraftClaw's edge detection system:

```
EV = (Probability × Decimal Odds) - 1

If EV > 0 → Positive Expected Value → THE ANCHOR ALERTS
If EV > 10% → Blasphemous Inefficiency → MAXIMUM CONVICTION
```

Sharp books (Pinnacle, Circa) set the "true line." Retail books (FanDuel, DraftKings) offer promotional odds. DraftClaw finds the gap.
...
```json
{
  ...
  "retailBooks": ["fanduel", "draftkings", "betmgm"],
  "evThreshold": 0.03,
  "alerts": {
    "discord": true,
    "telegram": true
...
- **Multi-channel inbox** — WhatsApp, Telegram, Slack, Discord, and more
...
**Built by Sakamoto Ops**

---

## Legacy Documentation

The following sections document the full technical capabilities inherited from the core platform.
...
- Google Chat (Chat API), Signal (signal-cli), iMessage (imsg)
- BlueBubbles, Microsoft Teams, Matrix, Zalo, WebChat (extensions)
