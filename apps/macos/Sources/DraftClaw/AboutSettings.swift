...
struct AboutSettings: View {
    ...
    var body: some View {
        VStack(spacing: 8) {
            ...
            Button {
                if let url = URL(string: "https://github.com/draftclaw/draftclaw") {
            ...
            VStack(alignment: .center, spacing: 6) {
                AboutLinkRow(
                    ...
                    title: "GitHub",
                    url: "https://github.com/draftclaw/draftclaw")
                AboutLinkRow(icon: "globe", title: "Website", url: "https://draftclaw.ai")
    ...
    private var buildTimestamp: String? {
        guard
            let raw =
                (Bundle.main.object(forInfoDictionaryKey: "DraftClawBuildTimestamp") as? String) ??
                (Bundle.main.object(forInfoDictionaryKey: "DraftClawBuildTimestamp") as? String)
        else { return nil }
    ...
    private var gitCommit: String {
        (Bundle.main.object(forInfoDictionaryKey: "DraftClawGitCommit") as? String) ??
            (Bundle.main.object(forInfoDictionaryKey: "DraftClawGitCommit") as? String) ??
            "unknown"
    }
