...
final class VoiceWakeOverlayController {
    ...
    let logger = Logger(subsystem: "ai.draftclaw", category: "voicewake.overlay")
    let enableUI: Bool

    /// Keep the voice wake overlay above any other DraftClaw windows, but below the system’s pop-up menus.
