...
struct SettingsRootView: View {
    ...
    var body: some View {
        ...
        .onReceive(NotificationCenter.default.publisher(for: .draftclawSelectSettingsTab)) { note in
    ...
    private var nixManagedBanner: some View {
        ...
        let configPath = self.snapshotPaths.configPath ?? DraftClawPaths.configURL.path
        let stateDir = self.snapshotPaths.stateDir ?? DraftClawPaths.stateDirURL.path
...
extension Notification.Name {
    static let draftclawSelectSettingsTab = Notification.Name("draftclawSelectSettingsTab")
}
