...
final class CanvasManager {
    ...
    private static let logger = Logger(subsystem: "ai.draftclaw", category: "CanvasManager")
    ...
    private nonisolated static let canvasRoot: URL = {
        ...
        return base.appendingPathComponent("DraftClaw/canvas", isDirectory: true)
    }()
    ...
    private static func resolveA2UIHostUrl(from raw: String?) -> String? {
        ...
        return base.appendingPathComponent("__draftclaw__/a2ui/").absoluteString + "?platform=macos"
    }
