...
enum AgentWorkspace {
    private static let logger = Logger(subsystem: "ai.draftclaw", category: "workspace")
    ...
    static func resolveWorkspaceURL(from userInput: String?) -> URL {
        ...
        if trimmed.isEmpty { return DraftClawConfigFile.defaultWorkspaceURL() }
