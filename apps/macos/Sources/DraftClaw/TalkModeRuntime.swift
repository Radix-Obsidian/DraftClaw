...
actor TalkModeRuntime {
    ...
    private let logger = Logger(subsystem: "ai.draftclaw", category: "talk.runtime")
    private let ttsLogger = Logger(subsystem: "ai.draftclaw", category: "talk.tts")
    ...
    private func latestAssistantText(sessionKey: String, since: Double? = nil) async -> String? {
        do {
            ...
            let decoded: [DraftClawChatMessage] = messages.compactMap { item in
