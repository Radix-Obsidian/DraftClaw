...
enum GatewayLaunchAgentManager {
    private static let logger = Logger(subsystem: "ai.draftclaw", category: "gateway.launchd")
    private static let disableLaunchAgentMarker = ".draftclaw/disable-launchagent"
...
extension GatewayLaunchAgentManager {
    ...
    {
        let command = CommandResolver.draftclawCommand(
            subcommand: "gateway",
