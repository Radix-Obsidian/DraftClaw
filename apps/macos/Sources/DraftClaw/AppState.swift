...
final class AppState {
    ...
    init(preview: Bool = false) {
        ...
        let configRoot = DraftClawConfigFile.loadDict()
    ...
    private func startConfigWatcher() {
        let configUrl = DraftClawConfigFile.url()
    ...
    private func syncGatewayConfigIfNeeded() {
        ...
        Task { @MainActor in
            ...
            var root = DraftClawConfigFile.loadDict()
            ...
            DraftClawConfigFile.saveDict(root)
        }
    }
...
extension AppState {
    static var preview: AppState {
        ...
        state.remoteProjectRoot = "~/Projects/draftclaw"
        state.remoteCliPath = ""
        return state
    }
}
