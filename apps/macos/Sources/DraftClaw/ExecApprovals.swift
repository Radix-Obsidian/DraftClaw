...
enum ExecApprovalsStore {
    private static let logger = Logger(subsystem: "ai.draftclaw", category: "exec-approvals")
    ...
    static func fileURL() -> URL {
        DraftClawPaths.stateDirURL.appendingPathComponent("exec-approvals.json")
    }

    static func socketPath() -> String {
        DraftClawPaths.stateDirURL.appendingPathComponent("exec-approvals.sock").path
    }
