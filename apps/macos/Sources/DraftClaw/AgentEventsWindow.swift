...
private struct EventRow: View {
    ...
    private func prettyJSON(_ dict: [String: DraftClawProtocol.AnyCodable]) -> String? {
...
struct AgentEventsWindow_Previews: PreviewProvider {
    static var previews: some View {
        let sample = ControlAgentEvent(
            ...
            data: [
                "phase": DraftClawProtocol.AnyCodable("start"),
                "name": DraftClawProtocol.AnyCodable("bash"),
            ],
            summary: nil)
