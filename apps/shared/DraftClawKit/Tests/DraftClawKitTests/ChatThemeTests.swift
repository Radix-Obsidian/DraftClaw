...
@Suite struct ChatThemeTests {
    @Test func assistantBubbleResolvesForLightAndDark() throws {
        ...
        let lightResolved = DraftClawChatTheme.resolvedAssistantBubbleColor(for: lightAppearance)
        let darkResolved = DraftClawChatTheme.resolvedAssistantBubbleColor(for: darkAppearance)
