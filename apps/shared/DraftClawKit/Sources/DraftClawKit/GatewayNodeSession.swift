...
public actor GatewayNodeSession {
    private let logger = Logger(subsystem: "ai.draftclaw", category: "node.gateway")
    ...
    static func invokeWithTimeout(
        ...
        let timeoutLogger = Logger(subsystem: "ai.draftclaw", category: "node.gateway")
        let timeout: Int = {
    ...
    private func decodeInvokeRequest(from payload: DraftClawProtocol.AnyCodable) throws -> NodeInvokeRequestPayload {
        do {
