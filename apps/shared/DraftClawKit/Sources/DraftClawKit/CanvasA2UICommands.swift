...
public enum DraftClawCanvasA2UICommand: String, Codable, Sendable {
...
public struct DraftClawCanvasA2UIPushParams: Codable, Sendable, Equatable {
...
public struct DraftClawCanvasA2UIPushJSONLParams: Codable, Sendable, Equatable {
