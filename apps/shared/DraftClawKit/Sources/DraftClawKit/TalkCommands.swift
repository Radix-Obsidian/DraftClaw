...
public enum DraftClawTalkCommand: String, Codable, Sendable {
...
public struct DraftClawTalkPTTStartPayload: Codable, Sendable, Equatable {
...
public struct DraftClawTalkPTTStopPayload: Codable, Sendable, Equatable {
    public var captureId: String
