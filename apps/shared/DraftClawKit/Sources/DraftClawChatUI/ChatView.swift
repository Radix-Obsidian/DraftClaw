...
@MainActor
public struct DraftClawChatView: View {
    public enum Style {
        case standard
        case onboarding
    }

    @State private var viewModel: DraftClawChatViewModel
    ...
    public init(
        viewModel: DraftClawChatViewModel,
    ...
    private var visibleMessages: [DraftClawChatMessage] {
        let base: [DraftClawChatMessage]
    ...
    private func mergeToolResults(in messages: [DraftClawChatMessage]) -> [DraftClawChatMessage] {
        ...
        for message in messages {
            ...
            let merged = DraftClawChatMessage(
                id: last.id,
                role: last.role,
                content: content,
    ...
    private func isToolResultMessage(_ message: DraftClawChatMessage) -> Bool {
        let role = message.role.lowercased()
        return role == "toolresult" || role == "tool_result"
    }

    private func toolCallIds(in message: DraftClawChatMessage) -> Set<String> {
        var ids = Set<String>()
    ...
    private func toolResultText(from message: DraftClawChatMessage) -> String {
