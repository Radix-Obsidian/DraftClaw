...
public typealias DraftClawPlatformImage = NSImage
#elseif canImport(UIKit)
import UIKit

public typealias DraftClawPlatformImage = UIImage
#endif

public struct DraftClawChatUsageCost: Codable, Hashable, Sendable {
...
public struct DraftClawChatUsage: Codable, Hashable, Sendable {
    public let input: Int?
    public let output: Int?
    public let cacheRead: Int?
    public let cacheWrite: Int?
    public let cost: DraftClawChatUsageCost?
    ...
    public init(from decoder: Decoder) throws {
        ...
        self.cost = try container.decodeIfPresent(DraftClawChatUsageCost.self, forKey: .cost)
        self.total =
...
public struct DraftClawChatMessageContent: Codable, Hashable, Sendable {
...
public struct DraftClawChatMessage: Codable, Identifiable, Sendable {
    public var id: UUID = .init()
    public let role: String
    public let content: [DraftClawChatMessageContent]
    public let timestamp: Double?
    public let toolCallId: String?
    public let toolName: String?
    public let usage: DraftClawChatUsage?
    ...
    public init(
        id: UUID = .init(),
        role: String,
        content: [DraftClawChatMessageContent],
        timestamp: Double?,
        toolCallId: String? = nil,
        toolName: String? = nil,
        usage: DraftClawChatUsage? = nil,
    ...
    public init(from decoder: Decoder) throws {
        ...
        self.usage = try container.decodeIfPresent(DraftClawChatUsage.self, forKey: .usage)
        self.stopReason = try container.decodeIfPresent(String.self, forKey: .stopReason)

        if let decoded = try? container.decode([DraftClawChatMessageContent].self, forKey: .content) {
...
public struct DraftClawChatHistoryPayload: Codable, Sendable {
...
public struct DraftClawSessionPreviewItem: Codable, Hashable, Sendable {
    public let role: String
    public let text: String
}

public struct DraftClawSessionPreviewEntry: Codable, Sendable {
    public let key: String
    public let status: String
    public let items: [DraftClawSessionPreviewItem]
}

public struct DraftClawSessionsPreviewPayload: Codable, Sendable {
    public let ts: Int
    public let previews: [DraftClawSessionPreviewEntry]

    public init(ts: Int, previews: [DraftClawSessionPreviewEntry]) {
        self.ts = ts
        self.previews = previews
    }
}

public struct DraftClawChatSendResponse: Codable, Sendable {
    public let runId: String
    public let status: String
}

public struct DraftClawChatEventPayload: Codable, Sendable {
    public let runId: String?
    public let sessionKey: String?
...
public struct DraftClawAgentEventPayload: Codable, Sendable, Identifiable {
...
public struct DraftClawChatPendingToolCall: Identifiable, Hashable, Sendable {
...
public struct DraftClawGatewayHealthOK: Codable, Sendable {
    public let ok: Bool?
}

public struct DraftClawPendingAttachment: Identifiable {
    public let id = UUID()
    public let url: URL?
    ...
    public let mimeType: String
    public let type: String
    public let preview: DraftClawPlatformImage?
    ...
    public init(
        ...
        mimeType: String,
        type: String = "file",
        preview: DraftClawPlatformImage?)
    {
        self.url = url
        self.data = data
        self.fileName = fileName
...
public struct DraftClawChatAttachmentPayload: Codable, Sendable, Hashable {
    public let type: String
    public let mimeType: String
    public let fileName: String
