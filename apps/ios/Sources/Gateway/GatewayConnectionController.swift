...
final class GatewayConnectionController {
    ...
    private func currentCaps() -> [String] {
        var caps = [DraftClawCapability.canvas.rawValue, DraftClawCapability.screen.rawValue]
        ...
        if cameraEnabled { caps.append(DraftClawCapability.camera.rawValue) }

        let voiceWakeEnabled = UserDefaults.standard.bool(forKey: VoiceWakePreferences.enabledKey)
        if voiceWakeEnabled { caps.append(DraftClawCapability.voiceWake.rawValue) }

        let locationModeRaw = UserDefaults.standard.string(forKey: "location.enabledMode") ?? "off"
        let locationMode = DraftClawLocationMode(rawValue: locationModeRaw) ?? .off
        if locationMode != .off { caps.append(DraftClawCapability.location.rawValue) }

        caps.append(DraftClawCapability.device.rawValue)
        caps.append(DraftClawCapability.photos.rawValue)
        caps.append(DraftClawCapability.contacts.rawValue)
        caps.append(DraftClawCapability.calendar.rawValue)
        caps.append(DraftClawCapability.reminders.rawValue)
        if Self.motionAvailable() {
            caps.append(DraftClawCapability.motion.rawValue)
        }
    ...
    private func currentCommands() -> [String] {
        var commands: [String] = [
            ...
            DraftClawSystemCommand.notify.rawValue,
            DraftClawChatCommand.push.rawValue,
        ...
        if caps.contains(DraftClawCapability.camera.rawValue) {
            commands.append(DraftClawCameraCommand.list.rawValue)
            commands.append(DraftClawCameraCommand.snap.rawValue)
            commands.append(DraftClawCameraCommand.clip.rawValue)
        }
        if caps.contains(DraftClawCapability.location.rawValue) {
            commands.append(DraftClawLocationCommand.get.rawValue)
        }
        if caps.contains(DraftClawCapability.device.rawValue) {
            commands.append(DraftClawDeviceCommand.status.rawValue)
            commands.append(DraftClawDeviceCommand.info.rawValue)
        }
        if caps.contains(DraftClawCapability.photos.rawValue) {
            commands.append(DraftClawPhotosCommand.latest.rawValue)
        }
        if caps.contains(DraftClawCapability.contacts.rawValue) {
            commands.append(DraftClawContactsCommand.search.rawValue)
            commands.append(DraftClawContactsCommand.add.rawValue)
        }
        if caps.contains(DraftClawCapability.calendar.rawValue) {
            commands.append(DraftClawCalendarCommand.events.rawValue)
            commands.append(DraftClawCalendarCommand.add.rawValue)
        }
        if caps.contains(DraftClawCapability.reminders.rawValue) {
            commands.append(DraftClawRemindersCommand.list.rawValue)
            commands.append(DraftClawRemindersCommand.add.rawValue)
        }
        if caps.contains(DraftClawCapability.motion.rawValue) {
            commands.append(DraftClawMotionCommand.activity.rawValue)
            commands.append(DraftClawMotionCommand.pedometer.rawValue)
        }
