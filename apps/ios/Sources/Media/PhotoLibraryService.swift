...
final class PhotoLibraryService: PhotosServicing {
    func latest(params: DraftClawPhotosLatestParams) async throws -> DraftClawPhotosLatestPayload {
        ...
        var results: [DraftClawPhotoPayload] = []
        ...
        return DraftClawPhotosLatestPayload(photos: results)
    }
    ...
    private static func renderAsset(
        ...
        maxWidth: Int,
        quality: Double,
        formatter: ISO8601DateFormatter) throws -> DraftClawPhotoPayload
    {
