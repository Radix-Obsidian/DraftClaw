...
final class ScreenController {
    ...
    /// Callback invoked when an draftclaw:// deep link is tapped in the canvas
    ...
    private static func bundledResourceURL(
        ...
        -> URL?
    {
        let bundle = DraftClawKitResources.bundle
...
/// Handles navigation policy to intercept draftclaw:// deep links from canvas
@MainActor
private final class ScreenNavigationDelegate: NSObject, WKNavigationDelegate {
        ...
        decisionHandler: @escaping @MainActor @Sendable (WKNavigationActionPolicy) -> Void)
    {
        ...
        // Intercept draftclaw:// deep links.
        if url.scheme?.lowercased() == "draftclaw" {
