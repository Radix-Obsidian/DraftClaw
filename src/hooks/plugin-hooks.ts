...
import type { DraftClawPluginApi } from "../plugins/types.js";
...
function resolveHookDir(api: DraftClawPluginApi, dir: string): string {
...
function normalizePluginHookEntry(api: DraftClawPluginApi, entry: HookEntry): HookEntry {
  return {
    ...entry,
    hook: {
      ...entry.hook,
