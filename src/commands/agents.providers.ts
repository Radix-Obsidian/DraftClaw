...
function resolveDefaultAccountId(cfg: DraftClawConfig, provider: ChannelId): string {
...
function shouldShowProviderEntry(entry: ProviderAccountStatus, cfg: DraftClawConfig): boolean {
...
export function summarizeBindings(cfg: DraftClawConfig, bindings: AgentBinding[]): string[] {
