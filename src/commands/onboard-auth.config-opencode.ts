...
export function applyOpencodeZenProviderConfig(cfg: DraftClawConfig): DraftClawConfig {
...
export function applyOpencodeZenConfig(cfg: DraftClawConfig): DraftClawConfig {
