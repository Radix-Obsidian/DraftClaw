...
export async function setupInternalHooks(
  ...
  await prompter.note(
    [
      ...
      "",
      "Learn more: https://docs.draftclaw.ai/hooks",
    ].join("\n"),
    "Hooks",
  );
  ...
  await prompter.note(
    [
      ...
      `  ${formatCliCommand("draftclaw hooks list")}`,
      `  ${formatCliCommand("draftclaw hooks enable <name>")}`,
      `  ${formatCliCommand("draftclaw hooks disable <name>")}`,
    ].join("\n"),
    "Hooks Configured",
  );
