...
const ensureDraftClawModelsJson = vi.fn().mockResolvedValue(undefined);
const resolveDraftClawAgentDir = vi.fn().mockReturnValue("/tmp/draftclaw-agent");
...
vi.mock("../config/config.js", () => ({
  ...
  STATE_DIR: "/tmp/draftclaw-state",
  loadConfig,
}));

vi.mock("../agents/models-config.js", () => ({
  ensureDraftClawModelsJson,
}));

vi.mock("../agents/agent-paths.js", () => ({
  resolveDraftClawAgentDir,
}));
