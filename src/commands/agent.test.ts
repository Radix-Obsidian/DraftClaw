...
async function withTempHome<T>(fn: (home: string) => Promise<T>): Promise<T> {
  return withTempHomeBase(fn, { prefix: "draftclaw-agent-" });
}

function mockConfig(
  home: string,
  storePath: string,
  agentOverrides?: Partial<NonNullable<NonNullable<DraftClawConfig["agents"]>["defaults"]>>,
  telegramOverrides?: Partial<NonNullable<DraftClawConfig["telegram"]>>,
