...
function resolveConfiguredModelRaw(cfg: DraftClawConfig): string {
...
function resolveConfiguredModelKeys(cfg: DraftClawConfig): string[] {
...
export function applyPrimaryModel(cfg: DraftClawConfig, model: string): DraftClawConfig {
...
export function applyModelAllowlist(cfg: DraftClawConfig, models: string[]): DraftClawConfig {
  const defaults = cfg.agents?.defaults;
