...
export function applyZaiConfig(cfg: DraftClawConfig): DraftClawConfig {
...
export function applyOpenrouterProviderConfig(cfg: DraftClawConfig): DraftClawConfig {
  const models = { ...cfg.agents?.defaults?.models };
...
export function applyVercelAiGatewayProviderConfig(cfg: DraftClawConfig): DraftClawConfig {
  const models = { ...cfg.agents?.defaults?.models };
...
export function applyVercelAiGatewayConfig(cfg: DraftClawConfig): DraftClawConfig {
...
export function applyOpenrouterConfig(cfg: DraftClawConfig): DraftClawConfig {
...
export function applyMoonshotProviderConfig(cfg: DraftClawConfig): DraftClawConfig {
  const models = { ...cfg.agents?.defaults?.models };
...
export function applyMoonshotConfig(cfg: DraftClawConfig): DraftClawConfig {
...
export function applyKimiCodeProviderConfig(cfg: DraftClawConfig): DraftClawConfig {
  const models = { ...cfg.agents?.defaults?.models };
...
export function applyKimiCodeConfig(cfg: DraftClawConfig): DraftClawConfig {
...
export function applySyntheticProviderConfig(cfg: DraftClawConfig): DraftClawConfig {
  const models = { ...cfg.agents?.defaults?.models };
...
export function applySyntheticConfig(cfg: DraftClawConfig): DraftClawConfig {
...
export function applyXiaomiProviderConfig(cfg: DraftClawConfig): DraftClawConfig {
  const models = { ...cfg.agents?.defaults?.models };
...
export function applyXiaomiConfig(cfg: DraftClawConfig): DraftClawConfig {
 ...
 */
export function applyVeniceProviderConfig(cfg: DraftClawConfig): DraftClawConfig {
  const models = { ...cfg.agents?.defaults?.models };
 ...
 */
export function applyVeniceConfig(cfg: DraftClawConfig): DraftClawConfig {
