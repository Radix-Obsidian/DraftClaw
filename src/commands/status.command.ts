...
export async function statusCommand(
  ...
  runtime.log(theme.heading("DraftClaw status"));
  runtime.log("");
  ...
  runtime.log(theme.muted(`Full report: ${formatCliCommand("draftclaw security audit")}`));
  runtime.log(theme.muted(`Deep probe: ${formatCliCommand("draftclaw security audit --deep")}`));
  ...
  runtime.log("");
  runtime.log("FAQ: https://docs.draftclaw.ai/faq");
  runtime.log("Troubleshooting: https://docs.draftclaw.ai/troubleshooting");
  runtime.log("");
  ...
  runtime.log(`  Need to share?      ${formatCliCommand("draftclaw status --all")}`);
  runtime.log(`  Need to debug live? ${formatCliCommand("draftclaw logs --follow")}`);
  if (gatewayReachable) {
    runtime.log(`  Need to test channels? ${formatCliCommand("draftclaw status --deep")}`);
  } else {
    runtime.log(`  Fix reachability first: ${formatCliCommand("draftclaw gateway probe")}`);
  }
}
