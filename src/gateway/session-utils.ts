...
import { type DraftClawConfig, loadConfig } from "../config/config.js";
...
function listConfiguredAgentIds(cfg: DraftClawConfig): string[] {
...
export function listAgentsForGateway(cfg: DraftClawConfig): {
  defaultId: string;
  mainKey: string;
  scope: SessionScope;
...
function resolveDefaultStoreAgentId(cfg: DraftClawConfig): string {
...
function resolveSessionStoreAgentId(cfg: DraftClawConfig, canonicalKey: string): string {
...
export function resolveGatewaySessionStoreTarget(params: { cfg: DraftClawConfig; key: string }): {
  agentId: string;
  storePath: string;
  canonicalKey: string;
  storeKeys: string[];
...
export function loadCombinedSessionStoreForGateway(cfg: DraftClawConfig): {
  storePath: string;
...
export function getSessionDefaults(cfg: DraftClawConfig): GatewaySessionsDefaults {
