...
export const DEFAULT_CLI_NAME = "draftclaw";

const KNOWN_CLI_NAMES = new Set([DEFAULT_CLI_NAME, "dc", "draftclaw"]);
const CLI_PREFIX_RE = /^(?:((?:pnpm|npm|bunx|npx)\s+))?(draftclaw|dc|draftclaw)\b/;
