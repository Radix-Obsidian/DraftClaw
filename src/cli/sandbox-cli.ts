...
const SANDBOX_EXAMPLES = {
  main: [
    ["draftclaw sandbox list", "List all sandbox containers."],
    ["draftclaw sandbox list --browser", "List only browser containers."],
    ["draftclaw sandbox recreate --all", "Recreate all containers."],
    ["draftclaw sandbox recreate --session main", "Recreate a specific session."],
    ["draftclaw sandbox recreate --agent mybot", "Recreate agent containers."],
    ["draftclaw sandbox explain", "Explain effective sandbox config."],
  ],
  list: [
    ["draftclaw sandbox list", "List all sandbox containers."],
    ["draftclaw sandbox list --browser", "List only browser containers."],
  ...
  recreate: [
    ["draftclaw sandbox recreate --all", "Recreate all containers."],
    ["draftclaw sandbox recreate --session main", "Recreate a specific session."],
    ["draftclaw sandbox recreate --agent mybot", "Recreate a specific agent (includes sub-agents)."],
    ["draftclaw sandbox recreate --browser --all", "Recreate only browser containers."],
    ["draftclaw sandbox recreate --all --force", "Skip confirmation."],
  ],
  explain: [
    ["draftclaw sandbox explain", "Show effective sandbox config."],
    ["draftclaw sandbox explain --session agent:main:main", "Explain a specific session."],
    ["draftclaw sandbox explain --agent work", "Explain an agent sandbox."],
    ["draftclaw sandbox explain --json", "JSON output."],
  ],
} as const;
...
export function registerSandboxCli(program: Command) {
  const sandbox = program
    ...
    .addHelpText(
      "after",
      () =>
        `\n${theme.muted("Docs:")} ${formatDocsLink("/cli/sandbox", "docs.draftclaw.ai/cli/sandbox")}\n`,
    )
    .action(() => {
