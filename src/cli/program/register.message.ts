...
${formatHelpExamples([
  ['draftclaw message send --target +15555550123 --message "Hi"', "Send a text message."],
  [
    'draftclaw message send --target +15555550123 --message "Hi" --media photo.jpg',
  ...
  [
    'draftclaw message react --channel discord --target 123 --message-id 456 --emoji "✅"',
    "React to a message.",
  ],
])}

${theme.muted("Docs:")} ${formatDocsLink("/cli/message", "docs.draftclaw.ai/cli/message")}`,
    )
    .action(() => {
