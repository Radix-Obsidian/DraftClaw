...
export const normalizePluginsConfig = (
  config?: DraftClawConfig["plugins"],
...
const hasExplicitMemorySlot = (plugins?: DraftClawConfig["plugins"]) =>
  Boolean(plugins?.slots && Object.prototype.hasOwnProperty.call(plugins.slots, "memory"));

const hasExplicitMemoryEntry = (plugins?: DraftClawConfig["plugins"]) =>
  Boolean(plugins?.entries && Object.prototype.hasOwnProperty.call(plugins.entries, "memory-core"));

const hasExplicitPluginConfig = (plugins?: DraftClawConfig["plugins"]) => {
  if (!plugins) {
    return false;
  }
