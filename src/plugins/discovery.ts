...
function deriveIdHint(params: {
  ...
  // package is scoped (example: @draftclaw/voice-call -> voice-call).
...
export function discoverDraftClawPlugins(params: {
  workspaceDir?: string;
  extraPaths?: string[];
  ...
  if (workspaceDir) {
    ...
    const workspaceExtDirs = [path.join(workspaceRoot, ".draftclaw", "extensions")];
