...
export function listSignalAccountIds(cfg: DraftClawConfig): string[] {
...
export function resolveDefaultSignalAccountId(cfg: DraftClawConfig): string {
...
function mergeSignalAccountConfig(cfg: DraftClawConfig, accountId: string): SignalAccountConfig {
...
export function listEnabledSignalAccounts(cfg: DraftClawConfig): ResolvedSignalAccount[] {
