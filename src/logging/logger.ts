...
export const DEFAULT_LOG_DIR = "/tmp/draftclaw";
export const DEFAULT_LOG_FILE = path.join(DEFAULT_LOG_DIR, "draftclaw.log"); // legacy single-file path

const LOG_PREFIX = "draftclaw";
...
function resolveSettings(): ResolvedSettings {
  let cfg: DraftClawConfig["logging"] | undefined =
    (loggingState.overrideSettings as LoggerSettings | null) ?? readLoggingConfig();
  if (!cfg) {
    try {
      const loaded = requireConfig("../config/config.js") as {
        loadConfig?: () => DraftClawConfig;
      };
