...
export type ChannelAgentToolFactory = (params: { cfg?: DraftClawConfig }) => ChannelAgentTool[];
...
export type ChannelAgentPromptAdapter = {
  messageToolHints?: (params: { cfg: DraftClawConfig; accountId?: string | null }) => string[];
};
...
export type ChannelMessageActionAdapter = {
  listActions?: (params: { cfg: DraftClawConfig }) => ChannelMessageActionName[];
  supportsAction?: (params: { action: ChannelMessageActionName }) => boolean;
  supportsButtons?: (params: { cfg: DraftClawConfig }) => boolean;
  supportsCards?: (params: { cfg: DraftClawConfig }) => boolean;
