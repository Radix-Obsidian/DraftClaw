...
function resolveMentionPatterns(cfg: DraftClawConfig | undefined, agentId?: string): string[] {
  if (!cfg) {
    return [];
  }
...
export function buildMentionRegexes(cfg: DraftClawConfig | undefined, agentId?: string): RegExp[] {
