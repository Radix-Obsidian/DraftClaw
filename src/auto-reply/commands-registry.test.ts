...
describe("commands registry", () => {
  ...
  it("normalizes telegram-style command mentions for the current bot", () => {
    expect(normalizeCommandBody("/help@draftclaw", { botUsername: "draftclaw" })).toBe("/help");
    expect(
      normalizeCommandBody("/help@draftclaw args", {
        botUsername: "draftclaw",
      }),
    ).toBe("/help args");
    expect(
      normalizeCommandBody("/help@draftclaw: args", {
  ...
  it("keeps telegram-style command mentions for other bots", () => {
    expect(normalizeCommandBody("/help@otherbot", { botUsername: "draftclaw" })).toBe(
      "/help@otherbot",
    );
  });
