...
import type { GatewayBindMode, GatewayTailscaleMode, DraftClawConfig } from "../config/config.js";
...
export async function configureGatewayForOnboarding(
  ...
  if (tailscaleMode !== "off" && flow !== "quickstart") {
    await prompter.note(
      ["Docs:", "https://docs.draftclaw.ai/gateway/tailscale", "https://docs.draftclaw.ai/web"].join(
        "\n",
      ),
      "Tailscale",
    );
