...
describe("update-startup", () => {
  ...
  beforeEach(async () => {
    ...
    tempDir = await fs.mkdtemp(path.join(os.tmpdir(), "draftclaw-update-check-"));
  ...
  it("logs update hint for npm installs when newer tag exists", async () => {
    const { resolveDraftClawPackageRoot } = await import("./draftclaw-root.js");
    ...
    vi.mocked(resolveDraftClawPackageRoot).mockResolvedValue("/opt/draftclaw");
