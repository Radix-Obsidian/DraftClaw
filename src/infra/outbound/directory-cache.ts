...
export class DirectoryCache<T> {
  ...
  private lastConfigRef: DraftClawConfig | null = null;

  constructor(private readonly ttlMs: number) {}

  get(key: string, cfg: DraftClawConfig): T | undefined {
  ...
  set(key: string, value: T, cfg: DraftClawConfig): void {
    this.resetIfConfigChanged(cfg);
  ...
  clear(cfg?: DraftClawConfig): void {
    this.cache.clear();
    if (cfg) {
  ...
  private resetIfConfigChanged(cfg: DraftClawConfig): void {
