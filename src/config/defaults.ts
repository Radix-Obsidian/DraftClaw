...
function resolveAnthropicDefaultAuthMode(cfg: DraftClawConfig): AnthropicAuthDefaultsMode | null {
...
export function applyMessageDefaults(cfg: DraftClawConfig): DraftClawConfig {
...
export function applyTalkApiKey(config: DraftClawConfig): DraftClawConfig {
...
export function applyModelDefaults(cfg: DraftClawConfig): DraftClawConfig {
  let mutated = false;
  let nextCfg = cfg;
...
export function applyAgentDefaults(cfg: DraftClawConfig): DraftClawConfig {
...
export function applyLoggingDefaults(cfg: DraftClawConfig): DraftClawConfig {
...
export function applyContextPruningDefaults(cfg: DraftClawConfig): DraftClawConfig {
...
export function applyCompactionDefaults(cfg: DraftClawConfig): DraftClawConfig {
  const defaults = cfg.agents?.defaults;
  if (!defaults) {
    return cfg;
  }
