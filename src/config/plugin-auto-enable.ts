import type { DraftClawConfig } from "./config.js";
...
function isTelegramConfigured(cfg: DraftClawConfig, env: NodeJS.ProcessEnv): boolean {
...
function isDiscordConfigured(cfg: DraftClawConfig, env: NodeJS.ProcessEnv): boolean {
...
function isSlackConfigured(cfg: DraftClawConfig, env: NodeJS.ProcessEnv): boolean {
  if (
...
function isSignalConfigured(cfg: DraftClawConfig): boolean {
...
function isIMessageConfigured(cfg: DraftClawConfig): boolean {
...
function isWhatsAppConfigured(cfg: DraftClawConfig): boolean {
...
function isGenericChannelConfigured(cfg: DraftClawConfig, channelId: string): boolean {
...
function collectModelRefs(cfg: DraftClawConfig): string[] {
  const refs: string[] = [];
...
function isProviderConfigured(cfg: DraftClawConfig, providerId: string): boolean {
...
function isPluginExplicitlyDisabled(cfg: DraftClawConfig, pluginId: string): boolean {
  const entry = cfg.plugins?.entries?.[pluginId];
  return entry?.enabled === false;
}

function isPluginDenied(cfg: DraftClawConfig, pluginId: string): boolean {
...
function ensureAllowlisted(cfg: DraftClawConfig, pluginId: string): DraftClawConfig {
...
function enablePluginEntry(cfg: DraftClawConfig, pluginId: string): DraftClawConfig {
  const entries = {
    ...cfg.plugins?.entries,
    [pluginId]: {
