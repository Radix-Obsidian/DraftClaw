...
function setGroupPolicyAllowlist(params: {
  ...
  const section = params.cfg.channels[params.channel as keyof DraftClawConfig["channels"]] as
...
function applyConfigFixes(params: { cfg: DraftClawConfig; env: NodeJS.ProcessEnv }): {
  cfg: DraftClawConfig;
  changes: string[];
  policyFlips: Set<string>;
} {
