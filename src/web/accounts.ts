...
function listConfiguredAccountIds(cfg: DraftClawConfig): string[] {
...
export function listWhatsAppAuthDirs(cfg: DraftClawConfig): string[] {
...
export function hasAnyWhatsAppAuth(cfg: DraftClawConfig): boolean {
  return listWhatsAppAuthDirs(cfg).some((authDir) => hasWebCredsSync(authDir));
}

export function listWhatsAppAccountIds(cfg: DraftClawConfig): string[] {
...
export function resolveDefaultWhatsAppAccountId(cfg: DraftClawConfig): string {
...
export function resolveWhatsAppAuthDir(params: { cfg: DraftClawConfig; accountId: string }): {
  authDir: string;
  isLegacy: boolean;
} {
...
export function listEnabledWhatsAppAccounts(cfg: DraftClawConfig): ResolvedWhatsAppAccount[] {
