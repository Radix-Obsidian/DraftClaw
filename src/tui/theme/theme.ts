...
const palette = {
  text: "#E8E3D5",
  dim: "#7B7F87",
  accent: "#00E092",      // DraftKings Green - Primary
  accentSoft: "#1F87FF",  // FanDuel Blue - Secondary
  border: "#3C414B",
  userBg: "#1A2332",
  userText: "#F3EEE0",
  systemText: "#9BA3B2",
  ...
  toolErrorBg: "#2F1F1F",
  toolTitle: "#00E092",    // DraftKings Green
  toolOutput: "#E1DACB",
  quote: "#1F87FF",        // FanDuel Blue
  quoteBorder: "#3B4D6B",
  code: "#00FF85",         // Positive EV Green
  codeBlock: "#1E232A",
  codeBorder: "#343A45",
  link: "#00E092",         // DraftKings Green
  error: "#FF4D4D",        // Negative EV Red
  success: "#00FF85",      // Positive EV Green
};
