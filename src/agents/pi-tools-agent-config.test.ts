...
describe("Agent-specific tool filtering", () => {
    ...
    const cfg: DraftClawConfig = {
      ...
      agents: {
        list: [
          {
            id: "restricted",
            workspace: "~/draftclaw-restricted",
            tools: {
  ...
  it("should allow different tool policies for different agents", () => {
    ...
    const mainTools = createDraftClawCodingTools({
      config: cfg,
      sessionKey: "agent:main:main",
    ...
    const familyTools = createDraftClawCodingTools({
      config: cfg,
  ...
  it("should apply group tool policy overrides (group-specific beats wildcard)", () => {
    ...
    const trustedTools = createDraftClawCodingTools({
      config: cfg,
  ...
  it("should apply per-sender tool policies for group tools", () => {
    ...
    const aliceTools = createDraftClawCodingTools({
      config: cfg,
    ...
    const bobTools = createDraftClawCodingTools({
      config: cfg,
      sessionKey: "agent:main:whatsapp:group:family",
      senderId: "bob",
  ...
  it("should not let default sender policy override group tools", () => {
    ...
    const adminTools = createDraftClawCodingTools({
      config: cfg,
