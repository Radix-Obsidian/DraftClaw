...
function resolveWatchPaths(workspaceDir: string, config?: DraftClawConfig): string[] {
  const paths: string[] = [];
...
export function ensureSkillsWatcher(params: { workspaceDir: string; config?: DraftClawConfig }) {
