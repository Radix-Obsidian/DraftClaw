...
function resolveAvatarSource(cfg: DraftClawConfig, agentId: string): string | null {
...
export function resolveAgentAvatar(cfg: DraftClawConfig, agentId: string): AgentAvatarResolution {
