  ...
  it("includes hardening and resource flags", () => {
    ...
    expect(args).toEqual(
      expect.arrayContaining([
        ...
        "draftclaw.sandbox=1",
        "--label",
        "draftclaw.sessionKey=main",
        "--label",
        "draftclaw.createdAtMs=1700000000000",
        "--label",
        "draftclaw.sandboxBrowser=1",
        "--read-only",
        "--tmpfs",
        "/tmp",
        "--network",
