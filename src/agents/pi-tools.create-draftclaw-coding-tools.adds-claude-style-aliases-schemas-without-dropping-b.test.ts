...
describe("createDraftClawCodingTools", () => {
  ...
  it("gates apply_patch behind tools.exec.applyPatch for OpenAI models", () => {
    ...
    const openAiTools = createDraftClawCodingTools({
      config,
    ...
    const anthropicTools = createDraftClawCodingTools({
      config,
  ...
  it("respects apply_patch allowModels", () => {
    ...
    const allowed = createDraftClawCodingTools({
      config,
      modelProvider: "openai",
      modelId: "gpt-5.2",
    });
    ...
    const denied = createDraftClawCodingTools({
      config,
      modelProvider: "openai",
      modelId: "gpt-5-mini",
    });
