...
describe("resolveApiKeyForProfile fallback to main agent", () => {
  ...
  beforeEach(async () => {
    ...
    // Set environment variables so resolveDraftClawAgentDir() returns mainAgentDir
    process.env.DRAFTCLAW_STATE_DIR = tmpDir;
    process.env.DRAFTCLAW_AGENT_DIR = mainAgentDir;
