...
export const A2UI_PATH = "/__draftclaw__/a2ui";

export const CANVAS_HOST_PATH = "/__draftclaw__/canvas";

export const CANVAS_WS_PATH = "/__draftclaw__/ws";
...
(() => {
  ...
  // Works on:
  // - iOS: window.webkit.messageHandlers.draftclawCanvasA2UIAction.postMessage(...)
  // - Android: window.draftclawCanvasA2UIAction.postMessage(...)
  const handlerNames = ["draftclawCanvasA2UIAction"];
  ...
  globalThis.DraftClaw = globalThis.DraftClaw ?? {};
  globalThis.DraftClaw.postMessage = postToNode;
  globalThis.DraftClaw.sendUserAction = sendUserAction;
  globalThis.draftclawPostMessage = postToNode;
  globalThis.draftclawSendUserAction = sendUserAction;
