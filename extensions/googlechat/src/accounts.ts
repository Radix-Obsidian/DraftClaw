...
export function listGoogleChatAccountIds(cfg: DraftClawConfig): string[] {
...
export function resolveDefaultGoogleChatAccountId(cfg: DraftClawConfig): string {
...
export function listEnabledGoogleChatAccounts(cfg: DraftClawConfig): ResolvedGoogleChatAccount[] {
