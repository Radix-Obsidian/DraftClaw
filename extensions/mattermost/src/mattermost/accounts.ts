...
export function listMattermostAccountIds(cfg: DraftClawConfig): string[] {
...
export function resolveDefaultMattermostAccountId(cfg: DraftClawConfig): string {
...
export function listEnabledMattermostAccounts(cfg: DraftClawConfig): ResolvedMattermostAccount[] {
