...
export function listZalouserAccountIds(cfg: DraftClawConfig): string[] {
...
export function resolveDefaultZalouserAccountId(cfg: DraftClawConfig): string {
...
function mergeZalouserAccountConfig(cfg: DraftClawConfig, accountId: string): ZalouserAccountConfig {
