...
if [[ -z "$version_content" ]]; then
  echo "<h2>DraftClaw $VERSION</h2>"
  echo "<p>Latest DraftClaw update.</p>"
  echo "<p><a href=\"https://github.com/draftclaw/draftclaw/blob/main/CHANGELOG.md\">View full changelog</a></p>"
  exit 0
fi
