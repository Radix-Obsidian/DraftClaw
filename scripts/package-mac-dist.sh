...
# Output:
# - dist/DraftClaw.app
# - dist/DraftClaw-<version>.zip
# - dist/DraftClaw-<version>.dmg
...
APP="$ROOT_DIR/dist/DraftClaw.app"
if [[ ! -d "$APP" ]]; then
...
ZIP="$ROOT_DIR/dist/DraftClaw-$VERSION.zip"
DMG="$ROOT_DIR/dist/DraftClaw-$VERSION.dmg"
NOTARY_ZIP="$ROOT_DIR/dist/DraftClaw-$VERSION.notary.zip"
